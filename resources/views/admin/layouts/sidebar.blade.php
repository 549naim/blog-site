    ...
    <div class="quixnav">
        <div class="quixnav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li class="nav-label">All Menus</li>
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                            class="icon icon-app-store"></i><span class="nav-text">Category</span></a>
                    <ul aria-expanded="false">
                        <li><a href="{{route('category_list')}}">All Categorys</a></li>
                ...
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                            class="icon icon-app-store"></i><span class="nav-text">Site Setting</span></a>
                    <ul aria-expanded="false">
                        <li><a href="{{ asset('admin/') }}app-profile.html">All Blogs</a></li>
                       
                        <li><a href="{{ asset('admin/') }}app-calender.html">Create Blog</a></li>
                    </ul>
                </li>
                <li><a class="" href="{{url('/')}}" aria-expanded="false"><i
                            class="icon icon-app-store"></i><span class="nav-text">Visit Website</span></a>   
                </li>
